...
type UseCounterContexType = ReturnType<typeof useCounterContex>

const initContexState: UseCounterContexType = {
   state: initState,
   increment: () => {},
   decrement: () => {},
...
export const CounterContext = createContext<UseCounterContexType>(initContexState)
